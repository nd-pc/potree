...
export class Sidebar{
	...
	initScene(){
		...
		let onMeasurementAdded = (e) => {
			...
			let icon = MeasuringTool.getMeasurementIcon(measurement);
			createNode(measurementID, measurement.name, icon, measurement);
		};

		let onVolumeAdded = (e) => {
			let volume = e.volume;
			let icon = MeasuringTool.getMeasurementIcon(volume);
		...
		let onProfileAdded = (e) => {
			...
			let icon = MeasuringTool.getMeasurementIcon(profile);
